...
using AspWebapipractiseid4_27102018.Data;
using AspWebapipractiseid4_27102018.Models;
...
namespace AspWebapipractiseid4_27102018
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            .AddConfigurationStore(configDb =>
            {
                configDb.ConfigureDbContext = db => db.UseMySql(connectionString,
                                                                sql => sql.MigrationsAssembly("AspWebapipractiseid4_27102018"));
